...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(
        "Bei deiner Anfrage ist etwas schief gelaufen. " + error
      );
    }
    setLoading(false);
  };
  ...
  return (
    <>
      ...
      <div className="contact">
        <p className="text">
          Falls du Interesse oder Fragen hast, schreibe uns gerne über dieses
          Kontaktformular. Wir freuen uns über neue junge Leute zwischen 15 und
          25 Jahren, die Lust haben, etwas zu bewirken. Und auch, wenn du nur
          einmal pro Monat kannst und nicht ganz so viel Zeit hast, bist du
          willkommen. Und falls du nicht weißt, ob ehrenamtliche Arbeit mit
          Kindern und Jugendlichen etwas für dich ist, kannst du uns ansprechen
        ...
        <form onSubmit={handleSubmit} className="form">
          ...
          <div className="question">
            ...
            <textarea
              ...
              minLength={5}
              maxLength={15000}
              className="question__input question__message"
